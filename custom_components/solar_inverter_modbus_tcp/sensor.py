...
DERIVED = [("work_status_text", "Work Status", None, None, None, ()), ("total_pv_power", "Total PV Power", "W", "power", "measurement", ("PV1 Power", "PV2 Power", "PV3 Power", "PV4 Power")), ("total_grid_power", "Total Grid Power", "W", "power", "measurement", ("Grid Active Power L1", "Grid Active Power L2", "Grid Active Power L3")), ("total_inverter_power", "Inverter Active Power", "W", "power", "measurement", ("Inverter Active Power L1", "Inverter Active Power L2", "Inverter Active Power L3")), ("backup_active_power", "Backup Active Power", "W", "power", "measurement", ("Backup Active Power A", "Backup Active Power B", "Backup Active Power C")), ("load_power", "Load Power", "W", "power", "measurement", ("Inverter Active Power", "Total Grid Power"))]
